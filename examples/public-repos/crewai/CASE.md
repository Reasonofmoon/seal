# Case: `crewAIInc/crewAI`

**Public subject:** [crewAIInc/crewAI](https://github.com/crewAIInc/crewAI) · ~58,749★ (snapshot at case authoring)

Role-playing autonomous agents — crew task completion advances the job.
