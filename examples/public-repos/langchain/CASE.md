# Case: `langchain-ai/langchain`

**Public subject:** [langchain-ai/langchain](https://github.com/langchain-ai/langchain) · ~146,640★ (snapshot at case authoring)

Agent engineering platform — chains/agents progress when steps run.
